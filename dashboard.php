    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12 col-lg-12 col-md-12">
                <h1 class="text-center mt-5 mb-3">สรุปยอดจำนวนงาน</h1>
                <hr>
                ...
                <hr>
                <div class="col-sm-12 col-lg-12 col-md-12">
                    <h1 class="mb-3 mt-3">งานวันนี้</h1>
                    <hr>
        ...
        ORDER BY dp.id DESC";
                ...
                <div class="col-sm-12 col-lg-12 col-md-12">
                    <h1 class="mb-3 mt-3">งานที่ถูกบันทึกไว้</h1>
                    <hr>
