                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" role="switch" name="selectedRows[]" value="<?= $result["id"] ?>">
                                                    <input class="thaiDateInput" name="deliveryDate[<?= $result["id"] ?>]" type="hidden">
            ...
            <div class="col-sm-6">
                ...
                <form action="system/insert.php" method="POST">
                    ...
                    <table id="example" class="table table-striped table-bordered">
                        <thead>
                            <?php
                            $sql = "SELECT numberWork FROM orderdata ORDER BY id DESC";
                            $stmt = $conn->prepare($sql);
                            $stmt->execute();
                            ...
                            if (!$row) {
                                ...
                                if (!$row) {
                                    ...
                                    if (strpos($selectedValue, 'S') !== false) {
                                        $newValueToCheck = $newNumerator . '/' . $newDenominator . " S";
                                    } else {
                                        $newValueToCheck = $newNumerator . '/' . $newDenominator . " S";
                                    }
                                }
                                    ...
                                    <th style="border: none;" colspan="1">
                                        <h5 style="font-weight: bold">
                                            <?php if (!$result) {
                                                ...
                                                echo $newValueToCheck;
                                            }
                                            ?></h5>
                                    </th>
                                    <td style="border: none;" colspan="1">
                                        <input type="text" name="reason" placeholder="เหตุผลและความจำเป็น" class="form-control">
                                    </td>
                                    <th style="border: none;" colspan="1">
                        ...
                        <tbody>
                            ...
                            for ($i = 1; $i <= 15; $i++) { ?>
                                <tr class="text-center">
                                    <td>
                                        <select style="width: 120px" class="form-select device-select" name="list<?= $i ?>" id="list<?= $i ?>" data-row="<?= $i ?>">
                                    ...
                                    <td><textarea rows="2" maxlength="60" id="quality<?= $i ?>" name="quality<?= $i ?>" class="limitedTextarea"></textarea></td>
                                    <td><input class="form-control" type="text" name="amount<?= $i ?>"></td>
                                    <td><input class="form-control" id="price<?= $i ?>" type="text" name="price<?= $i ?>"></td>
                                </tr>
