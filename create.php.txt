                  ...
                  <tbody>
                    ...
                    for ($i = 1; $i <= 15; $i++) { ?>
                      <tr class="text-center">
                        ...
                        <td><textarea rows="2" maxlength="60" name="quality<?= $i ?>" class="limitedTextarea"></textarea>
                        </td>
                        ...
                        <tbody>
                          ...
                          for ($i = 1; $i <= 15; $i++) { ?>
                            <tr class="text-center">
                              ...
                              <td>
                                <textarea rows="2" maxlength="60" id="quality<?= $i ?>" name="quality<?= $i ?>" class="limitedTextarea"></textarea>
                              </td>
                              <td><input value="" style="width: 2rem;" id="amount<?= $i ?>" type="text" name="amount<?= $i ?>"></td>
                              <td><input value="" style="width: 4rem;" id="price<?= $i ?>" type="text" name="price<?= $i ?>"></td>
                              <td><input value="" style="width: 4rem;" id="unit<?= $i ?>" type="text" name="unit<?= $i ?>">
                              </td>
                            </tr>
